...
public class PlantGenGuiApp extends Application {
  ...
  private void runRandomScript(
      GraphicsContext plantGc,
      GraphicsContext leafGc,
      GraphicsContext flowerGc,
  ...
  private void randomizeValues() {
    ...
    leaf1Color.set(Color.hsb(random.nextGaussian() * 20 + 110,
        random.nextDouble() * 0.8 + 0.2,
        random.nextDouble() * 0.6 + 0.4,
        random.nextDouble() * 0.4 + 0.6
    ));
    leaf2Color.set(Color.hsb(random.nextGaussian() * 20 + 110,
        random.nextDouble() * 0.8 + 0.2,
        random.nextDouble() * 0.6 + 0.4,
        random.nextDouble() * 0.6 + 0.3
    ));
    petal1Color.set(Color.hsb(random.nextDouble() * 360,
        random.nextDouble() * 0.8 + 0.2,
        random.nextDouble() * 0.2 + 0.8,
        random.nextDouble() * 0.4 + 0.6
    ));
    petal2Color.set(Color.hsb(random.nextDouble() * 360,
        random.nextDouble() * 0.8 + 0.2,
        random.nextDouble() * 0.2 + 0.8,
        random.nextDouble() * 0.6 + 0.3
    ));
    flowerCenterColor.set(Color
        .hsb(random.nextDouble() * 360, random.nextDouble() * 0.2 + 0.8, random.nextDouble() * 0.2 + 0.8));
  }
